...
2. Revisa **Inicio**: horas mes, funcionarios requeridos, ICU ponderado y vencimientos.
3. Abre **Estudio 167** y usa la calculadora rápida para explicar `horas mes / 167`.
4. Entra a **Actividades** y registra una actividad con periodicidad, repeticiones y minutos por repetición.
5. Filtra por área, responsable, riesgo, prioridad, estado o mes.
6. Abre **Alertas** y aplica una recomendación para mostrar revisión humana y trazabilidad.
7. Entra a **Reportes**, exporta CSV y abre la vista imprimible para PDF.
8. Abre **Guía y métricas** para explicar cada indicador y los hitos cubiertos.
9. Entra a **Auditoría** para evidenciar cambios y recomendaciones aplicadas.
10. Copia la URL pública y credenciales en tu presentación.
